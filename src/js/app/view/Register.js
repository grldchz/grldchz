/**
	...
	Register.js is part of GRLDCHZ
			...
			return (
				<form role="form" onSubmit={this.onSubmit}>
					...
					<div className="form-group">
						...
						<input type="text" className="form-control" name="firstname" onChange={this.onChange} value={this.state.firstname}/>
					</div>
					<div className="form-group">
						<label for="lastname">Last Name:</label>
						<input type="text" className="form-control" name="lastname" onChange={this.onChange} value={this.state.lastname}/>
					</div>
					<div className="form-group">
					...
					<button type="button" className="btn btn-default" onClick={this.props.hideRegister}>Cancel</button>
				</form>			
			);
		},
		show : function(){
